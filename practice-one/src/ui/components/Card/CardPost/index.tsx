...
export const CardPost = ({
  ...
  >
    {/* card image */}
    <Image
      className={`rounded-xl w-84.5 h-46.5 ${isVerticle ? "sm:w-87.5 sm:h-50" : "sm:w-[190px] sm:[190px]"} lg:w-85 lg:h-47.5`}
      width={360}
      height={190}
      src={imageSrc}
      alt={alt}
    ...
    <div className="flex flex-col flex-1">
      ...
      {/* card footer */}
      <div
        className={`flex flex-1 bg-white-90 rounded-xl px-4 py-3.5 ${isVerticle && "mx-2.5"}`}
      >
        <Avatar
          width={44}
          height={44}
          url="https://images.unsplash.com/photo-1712847331947-9460dd2f264b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxzZWFyY2h8MXx8bW9kZWx8ZW58MHx8MHx8fDA%3D"
